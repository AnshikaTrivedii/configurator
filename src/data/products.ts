...
export const products: Product[] = [
...

  {
    ...
    enabled: true,
    digitalStandeeMatrixKey: '2x11',
    digitalStandeeCabinetGrid: { columns: 2, rows: 11 },
    digitalStandeeMatrixVariants: {
      '2x11': {
        type: 'Non-Model B',
        productId: 'orion-p18-digital-standee',
        cabinetGrid: { columns: 2, rows: 11 },
        specifications: {
        ...
        price: { price: 140000, siChannelPrice: 133000, resellerPrice: 126000 },
      },
      '3x11': {
        type: 'Model B',
        productId: 'orion-p18-digital-standee-2',
        cabinetGrid: { columns: 3, rows: 11 },
        specifications: {
        ...
        price: { price: 180000, siChannelPrice: 171000, resellerPrice: 162000 },
      },
    },
  ...
  },
  {
    ...
    name: 'Orion P1.8 Indoor Standee Display (Model B)',
    category: 'Digital Standee Series',
    enabled: false,
    digitalStandeeMatrixKey: '3x11',
    digitalStandeeCabinetGrid: { columns: 3, rows: 11 },
    digitalStandeeVariantOf: 'orion-p18-digital-standee',
  ...
  },
  {
    ...
    digitalStandeeMatrixVariants: {
      '2x11': {
        type: 'Non-Model B',
        productId: 'orion-p25-digital-standee',
        cabinetGrid: { columns: 2, rows: 11 },
        specifications: {
        ...
        price: { price: 120000, siChannelPrice: 114000, resellerPrice: 108000 },
      },
      '3x11': {
        type: 'Model B',
        productId: 'orion-p25-digital-standee-2',
        cabinetGrid: { columns: 3, rows: 11 },
        specifications: {
        ...
        price: { price: 130000, siChannelPrice: 123500, resellerPrice: 117000 },
      },
    },
  ...
  },
  {
    ...
    name: 'Orion P2.5 Indoor Standee Display (Model B)',
    category: 'Digital Standee Series',
    enabled: false,
    digitalStandeeMatrixKey: '3x11',
    digitalStandeeCabinetGrid: { columns: 3, rows: 11 },
    digitalStandeeVariantOf: 'orion-p25-digital-standee',
  ...
  },
  {
    ...
    digitalStandeeMatrixVariants: {
      '2x11': {
        type: 'Non-Model B',
        productId: 'orion-p4-digital-standee',
        cabinetGrid: { columns: 2, rows: 11 },
        specifications: {
        ...
        price: { price: 150000, siChannelPrice: 142500, resellerPrice: 135000 },
      },
      '3x11': {
        type: 'Model B',
        productId: 'orion-p4-digital-standee-2',
        cabinetGrid: { columns: 3, rows: 11 },
        specifications: {
        ...
        price: { price: 185000, siChannelPrice: 175750, resellerPrice: 166500 },
      },
    },
  ...
  },
  {
    ...
    name: 'Orion P4 Indoor Standee Display (Model B)',
    category: 'Digital Standee Series',
    enabled: false,
    digitalStandeeMatrixKey: '3x11',
    digitalStandeeCabinetGrid: { columns: 3, rows: 11 },
    digitalStandeeVariantOf: 'orion-p4-digital-standee',
