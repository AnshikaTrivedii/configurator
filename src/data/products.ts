...
export const products: Product[] = [
  ...
  // Rental Series Indoor P2.6
  {
    ...
    image: '/products/rental-series/indoor-p2.6.png',
    resolution: { width: 192, height: 192 },
  ...
  // Rental Series Indoor P2.97
  {
    ...
    category: 'Rental Series',
    image: '/products/rental-series/indoor-p2.97.png',
  ...
  // Rental Series Outdoor P3.8
  {
    ...
    category: 'Rental Series',
    image: '/products/rental-series/outdoor-p3.8.png',
  ...
  // Rental Series Outdoor P4.8
  {
    ...
    category: 'Rental Series',
    image: '/products/rental-series/outdoor-p4.8.png',
