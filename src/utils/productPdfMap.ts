...
export const productPdfMap: Record<string, string> = {
  ...
  'Nexa-C P1.25mm': 'https://orion-led-quotations.s3.ap-south-1.amazonaws.com/Product+specs+pdf+/nexa+series+/Nexa-C+P1.25mm+108inch.pdf',
  'Nexa-C P1.25 216"': 'https://orion-led-quotations.s3.ap-south-1.amazonaws.com/Product+specs+pdf+/nexa+series+/Nexa-C+P1.25mm+216inch.pdf',
...
const productNameAliasMap: Record<string, string> = {
  ...
  'Nexa Series 108" P1.25 (Sigma)': 'Nexa-C P1.25mm',
  'Nexa Series 135" P1.56 (Sigma)': 'Nexa-C P1.56mm',
  'Nexa Series 162" P1.875 (Sigma)': 'Nexa-C P1.875mm',
  'Nexa Series 216" P1.25 (Sigma)': 'Nexa-C P1.25 216"',
