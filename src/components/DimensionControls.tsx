  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8">
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        <h3 className="text-base sm:text-lg font-semibold text-gray-800">Target Display Size</h3>
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-white border rounded-lg px-3 py-2 pr-8 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <div className="flex items-center gap-1 bg-white border rounded-lg px-2 sm:px-3 py-1.5 sm:py-2 min-w-[80px] sm:min-w-[100px]">
              <input
                type="number"
