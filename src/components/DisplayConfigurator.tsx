    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8 py-6">
          <h1 className="text-3xl font-bold text-gray-900">ATENTI ORION</h1>
                      ...
                      <div className="bg-white rounded-lg shadow-lg max-w-3xl w-full p-6 relative">
                        ...
                        <div className="h-[70vh] overflow-auto border rounded">
                          ...
                          <div className="mt-2 text-sm text-gray-500">
                            For full details, <a href={selectedProduct.pdf} target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">open PDF in new tab</a>.
                          </div>
                        </div>
                      </div>
                    </div>
